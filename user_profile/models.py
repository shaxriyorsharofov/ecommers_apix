...
from dajngo.core.validators import MaxValueValidator,MinValueValidator,RegexValidator
...
from core.hande_images import compress_image 
...
class Address(TimeStampedModel):
    ...
    building_number = models.IntegerField(null=True,blank=True,validators = [MinValueValidator(1)])
    appartment_number = models.IntegerField(blank=True,blank=True,validators =[MinValueValidtor(1)])
...
class NationalIDImage(models.Model):
    user = models.ForeignKey(User,related_name="national_ids",on_delete=models.CASCADE)
