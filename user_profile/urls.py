...
urlpatterns = [
    ...
    path('account_confirm_email/sent/',TemplateView.as_view(),name='account_confirm_email'),
    path('account_confirm_email/<str:key>',views.VerifyEmailView.as_view(),name='rest_verify_email'),
    path('password/reset/confirm/<str:uidb64>/<str:token>/',views.PasswordResetConfirmView.as_view(),name='password_reset_confirm'),
    path('verify_sms/<int:pk>/',views.VerifySMSView.as_view()),
    path('resend-sms/',views.ResendSMSAPIView.as_view()),
    path('deactive-user/',views.DeactiveateUserView.as_view()),
    path('reactive-user/',views.CancelDeactivateUserView.as_view()),
    path('profile/<int:pk>/',views.ProfileAPIView.as_view()),
    path('user/<str:username>/',views.UserDetailView.as_view()),
    path('address/',views.ListAddressAPIView.as_view()),
