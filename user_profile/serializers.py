...
class CustomRegisterSerializer(RegisterSerializer):
    ...
    phone_number = PhoneNumberField(required=True,write_only=True,validators=[UniqueValidator(queryset=Profile.objects.all(),message=_("A user is already registered with this phone number."),)],)
    ...
    def create_profile(self,user,validated_data):
        ...
        user.profile.save()
    def custome_signup(self,request,user):
...
class PasswordChangeSerializer(serializers.Serializer):
    ...
    def __init__(self,*args,**kwargs):
        ...
        super(PasswordChangeSerilizer,self).__init__(*args,**kwargs)
