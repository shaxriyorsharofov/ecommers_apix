...
class NotificationAPIView(RetrieveDestroyAPIView):
    permission_classes = [permissions.IsAuthenticated]
    serialzier_class = NotificationMiniserializer 
    ...
    def destroy(self,request,*args,**kwargs):
        ...
        notification.delete()
        return Response({"detail":_("this notification is deleted succesfully.")},
...
class MarkedAllAsReadNotificationView(APIView):
    ...
    def post(self,request):
        ...
        for notification in notifications:
            if notification.user != user:
                raise PermissionDenied("this notification don't belong to you.")
